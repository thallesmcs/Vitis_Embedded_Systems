...
//               f:/Xilinx/hls_2024/adder_new/adder_new/hls/impl/verilog/project.gen/sources_1/bd/bd_0/ip/bd_0_hls_inst_0/bd_0_hls_inst_0_stub.v
...
(* CHECK_LICENSE_TYPE = "bd_0_hls_inst_0,adder_new,{}" *) (* CORE_GENERATION_INFO = "bd_0_hls_inst_0,adder_new,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=adder_new,x_ipVersion=1.0,x_ipCoreRevision=2114171154,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_BUS_A_ADDR_WIDTH=6,C_S_AXI_BUS_A_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "adder_new,Vivado 2024.2" *) (* hls_module = "yes" *) 
